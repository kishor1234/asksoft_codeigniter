...
//Mail Configuration 
    ...
    public function createDBO() {
        ...
        if (LIVE) {
            $tempObjArray = array();
            $tempObjArray["pcfoto_db"] = new mysqli("localhost", "pcfoto_db", "yEhnBj46iX", "pcfoto_db");
            $_SESSION["db_1"] = "pcfoto_db";
        } else {
            $tempObjArray = array();
            $tempObjArray["pcfoto"] = new mysqli("localhost", "root", "root@123", "pcfoto");
            $_SESSION["db_1"] = "pcfoto";
        }
        /*
          $tempObjArray = array();
