    ...
    public function initialize() {
        ...
        try {
            ...
            if (isset($_POST)) {
                ...
                $data = array("branch" => $this->filterPost("branch"),"title" => $this->filterPost("title"), "meta" => $this->filterPost("meta"),"description" => $this->filterPost("txtEditor"), "category" => $this->filterPost("category"), "byw" => $_SESSION["login"], "ip" => $_SERVER["REMOTE_ADDR"]);
            } else {
                $data = array("branch" => $this->filterPost("branch"),"meta" => $this->filterPost("meta"), "title" => $this->filterPost("title"), "description" => $this->filterPost("txtEditor"), "category" => $this->filterPost("category"), "byw" => $_SESSION["login"], "ip" => $_SERVER["REMOTE_ADDR"]);
            }
