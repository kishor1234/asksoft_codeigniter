    ...
    public function initialize() {
        ...
        try {
            ...
            if (!empty($_FILES)) {
                ...
                $data = array("banner_path" => $path2, "banner_url" => $filename2, "branch" => $this->filterPost("branch"), "title" => $this->filterPost("title"), "meta" => $this->filterPost("meta"),"description" => $this->filterPost("txtEditor"), "img" => $filename, "path" => $path, "category" => $this->filterPost("category"), "byw" => $_SESSION["login"], "ip" => $_SERVER["REMOTE_ADDR"]);
