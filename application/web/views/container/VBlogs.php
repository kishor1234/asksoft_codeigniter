                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="lest_news_box_wrapper blog_cat_image_wrapper ">
                            <div class="lest_news_cont_wrapper news_blog_btm_bordr">
                                <h5><a href="/in/blogs/<?php echo strtolower(str_replace(" ", "-", $row["title"])); ?>"><?php echo $row["title"]; ?></a></h5>
                                ...
                                <p>
                                <div class="lest_news_img_wrapper img-effect " style="width: 300px; float: left;">
                                    <img src="<?php echo $row["img"]; ?>" alt="blog_img" style="width: 300px; height: 200px;">
                                ...
                                <a class="btn btn-info btn-custom-black theamcolor" href="/in/blogs/<?php echo strtolower(str_replace(" ", "-", $row["title"])); ?>" style="float:right;">Continue Reading...</a>
